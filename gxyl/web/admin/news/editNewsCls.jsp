      ...
      <tr>
        ...
        <td bgcolor="#f3ffe3">
          ...
          <tr>
            ...
            <td><input name="name" value="${newsCls.name}"/></td>
          </tr>
          <tr>
            <td height="26" align="right">标识：</td>
            <td>&nbsp;${newsCls.clsName}</td>
          </tr>
        </table>
        <input type="hidden" name="clsName" value="${newsCls.clsName}" />
        <input type="hidden" name="newsClsAutoid" value="${newsCls.newsClsAutoid}"/>
        	<br/>
