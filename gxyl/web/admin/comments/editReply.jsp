...
<body>
<form id="form" action="modifyReply.do" method="post" onsubmit="return check();">
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td bgcolor="#f3ffe3">
          ...
          <tr>
            <td height="26" width="70" align="right">回复时间：</td>
            <td colspan="2">
             	<input name="date" value="<fmt:formatDate value='${reply.date}' pattern='yyyy-MM-dd HH:mm:ss'/>" style="width:300px;" class="Wdate" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
            </td>
          </tr>
          <tr>
            <td align="right">回复内容：</td>
            <td width="675"><textarea name="content" id="content" rows="8" cols="80">${reply.content}</textarea></td>
          </tr>
        </table>
        <input type="hidden" name="replyAutoid" value="${reply.replyAutoid}"/>
        <input type="hidden" name="commentsAutoid" value="${reply.commentsAutoid}"/>
        	<br/>
        	<div align="center">
