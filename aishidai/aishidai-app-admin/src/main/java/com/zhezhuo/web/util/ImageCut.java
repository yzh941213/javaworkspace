...
public class ImageCut {
	...
	public static void cut(InputStream is, ByteArrayOutputStream out, int x, int y, int destWidth, int destHeight)
			throws IOException {
		cut(ImageIO.read(is), out, x, y, destWidth, destHeight);
	}

	public static void cut(BufferedImage bi, ByteArrayOutputStream out, int x, int y, int destWidth, int destHeight) {
		try {
			Image img;
			ImageFilter cropFilter;
			// 读取源图像
